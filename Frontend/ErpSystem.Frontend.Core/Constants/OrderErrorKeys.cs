...
public static class OrderErrorKeys
{
    private static readonly Dictionary<string, string> _translations = new()
    {
        ...
        ["OrderCannotBeCompleted"] = "Поръчката не може да бъде завършена. Само чакащи поръчки могат да бъдат завършени",
        ["OrderCannotBeCanceled"] = "Поръчката не може да бъде отменена. Само чакащи поръчки могат да бъдат отменени",
        ["OrderCannotBeDeleted"] = "Поръчката не може да бъде изтрита. Само чакащи поръчки могат да бъдат изтрити",
