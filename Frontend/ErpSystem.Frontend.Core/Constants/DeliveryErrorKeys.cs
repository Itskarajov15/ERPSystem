...
public static class DeliveryErrorKeys
{
    private static readonly Dictionary<string, string> _translations =
        new()
        {
            ...
            ["DeliveryCannotBeStarted"] =
                "Доставката не може да бъде започната. Само регистрирани доставки могат да бъдат започнати",
            ["DeliveryCannotBeCompleted"] =
                "Доставката не може да бъде завършена. Само доставки в обработка могат да бъдат завършени",
            ["DeliveryCannotBeDeleted"] =
                "Доставката не може да бъде изтрита. Само регистрирани доставки могат да бъдат изтрити",
