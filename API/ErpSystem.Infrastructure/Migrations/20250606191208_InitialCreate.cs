...
namespace ErpSystem.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ControllerName = table.Column<string>(
                        type: "nvarchar(100)",
                        maxLength: 100,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    RoleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RoutePermissionId = table.Column<Guid>(
                ...
                {
                    table.PrimaryKey(
                        "PK_RoleRoutePermission",
                        x => new { x.RoleId, x.RoutePermissionId }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryNumber = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductSku = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: false
                    ),
            ...
            migrationBuilder.InsertData(
                ...
                {
                    {
                        new Guid("2bf41498-995a-4a13-8391-f6e0f5223f08"),
                        "гр. София, бул. Витоша 128",
                        "Стефан Василев",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "stefan.vasilev@petrov-partners.bg",
                        false,
                        null,
                        null,
                        "Адвокатско Дружество Петров и Партньори",
                        "+359889123456",
                    },
                    {
                        new Guid("6c6b1118-9a9b-4bd2-bc19-933bdbe74710"),
                        "гр. Варна, ул. Приморски 12",
                        "Петър Атанасов",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "petar.atanasov@it-solutions.bg",
                        false,
                        null,
                        null,
                        "IT Солюшънс България ООД",
                        "+359867345678",
                    },
                    {
                        new Guid("b98c77d0-6417-4791-a3ee-1acf0d7e18cd"),
                        "гр. Бургас, бул. Демокрация 45",
                        "Румяна Кирилова",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "rumyana.kirilova@school-botev.bg",
                        false,
                        null,
                        null,
                    ...
                    {
                        new Guid("eb81d76e-d727-47ec-b4e5-af9503baa6fd"),
                        "гр. Пловдив, ул. Марица 89",
                        "Анна Христова",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "anna.hristova@balance-accounting.bg",
                        false,
                        null,
                        null,
                        "Счетоводна Къща Баланс ЕООД",
                        "+359878234567",
                    },
                    {
                        new Guid("f490ae0c-4abe-42ac-b499-fed676becadd"),
                        "гр. Русе, ул. Дунав 78",
                        "Владимир Михайлов",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "vladimir.mihaylov@ruse-municipality.bg",
                        false,
                        null,
                        null,
            ...
            migrationBuilder.InsertData(
                ...
                {
                    {
                        new Guid("1643b266-ea12-4b44-a4f7-a96a41fec121"),
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        false,
                        null,
                    ...
                    {
                        new Guid("3d1cecab-419f-4ec0-b2a6-a8260cd0d1e3"),
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        false,
                        null,
                    ...
                    {
                        new Guid("b6525ce3-9252-4b5e-9098-84490c36c487"),
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        false,
                        null,
            ...
            migrationBuilder.InsertData(
                ...
                {
                    {
                        new Guid("07ecf61b-33cd-430b-be4e-895da076f73e"),
                        "гр. Пловдив, бул. Русия 45",
                        "Мария Георгиева",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "maria.georgieva@office-materials.bg",
                        false,
                        null,
                        null,
                        "Канцеларски Материали БГ АД",
                        "+359877234567",
                    },
                    {
                        new Guid("50c8493b-76aa-4b61-ae9d-6eb69cfaf785"),
                        "гр. Бургас, ул. Александровска 67",
                        "Елена Димитрова",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "elena.dimitrova@stationery-group.bg",
                        false,
                        null,
                        null,
                        "Стейшънъри Груп ЕООД",
                        "+359855456789",
                    },
                    {
                        new Guid("d2e467f9-c4c5-4641-b535-620566e37d8b"),
                        "гр. Варна, ул. Васил Левски 23",
                        "Георги Стоянов",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "georgi.stoyanov@pro-office.bg",
                        false,
                        null,
                        null,
                        "Професионален Офис ООД",
                        "+359866345678",
                    },
                    {
                        new Guid("f742a28e-b0e0-4c50-bf4f-bf295ebaa9dd"),
                        "гр. София, ул. Витоша 15",
                        "Иван Петров",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "ivan.petrov@office-express.bg",
                        false,
                        null,
                        null,
                        "Офис Експрес ЕООД",
                    ...
                    {
                        new Guid("facca2c6-49ff-471a-a853-8796ea574217"),
                        "гр. Стара Загора, ул. Гурко 34",
                        "Николай Тодоров",
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "nikolay.todorov@office-furniture.bg",
                        false,
                        null,
                        null,
                        "Офис Мебели и Техника АД",
                        "+359844567890",
                    },
                }
            );
            ...
            migrationBuilder.InsertData(
                ...
                {
                    {
                        new Guid("3805cab6-332f-4909-8546-679e0b2f2033"),
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "Картонени класьори за документи А4, с метални скоби",
                        false,
                        null,
                        null,
                        "Папки класьори А4",
                    ...
                    {
                        new Guid("4007b57f-afdb-45cc-9eff-b66b0f31b154"),
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "Комплект от 10 сини химикалки за ежедневно писане, гладко писане",
                        false,
                        null,
                        null,
                    ...
                    {
                        new Guid("980fcb9f-f9f1-4d9c-93cc-fe35b7e48b32"),
                        new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        "system",
                        "Висококачествена копирна хартия А4, 80g/m², 500 листа в пакет",
                        false,
                        null,
                        null,
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "RoleRoutePermission");
            ...
            migrationBuilder.DropTable(name: "UnitOfMeasures");
